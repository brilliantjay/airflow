...
with DAG(
    ...
    insrt_postgres = PythonOperator(task_id="insrt_postgres", python_callable=insrt_postgres, op_kwargs={'postgres_conn_id':'conn-db-postgres-custom',
                   'tbl_nm':"TbCoronal19CountStatus_bulk1",
                   'file_nm':'/opt/airflow/files/TbCoronal19CountStatus/{{data_interval_end.in_timezone("Asia/Seoul") | ds_nodash }}/TbCoronal19CountStatus.csv'})            
